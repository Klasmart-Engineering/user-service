...
describe('class', () => {
    ...
    describe('removeTeacher', () => {
        ...
        context('when authorized within a school', () => {
            ...
            beforeEach(async () => {
                ...
                const roleOrg = await createRole(testClient, organizationId)
                await grantPermission(
                    testClient,
                    role.role_id,
                    PermissionName.delete_teacher_from_class_20446,
    ...
    describe('AddProgramsToClasses', () => {
        ...
        beforeEach(async () => {
            ...
            classes = [
                createClassFactory(undefined, otherOrganization),
                ...createClassesFactory(2, organization),
            ]
            programs = [
                createProgram(otherOrganization),
                createProgram(organization),
