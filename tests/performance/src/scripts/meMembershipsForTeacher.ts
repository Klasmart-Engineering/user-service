...
import { meMembershipForTeacher1, meMembershipForTeacher2, meMembershipForTeacher3,  meMembershipForTeacher4, meMembershipForTeacher5  } from '../queries/schools';
