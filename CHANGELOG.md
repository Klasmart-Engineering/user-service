...
#### [v2.1.1](https://bitbucket.org/calmisland/kidsloop-user-service/compare/v2.1.1..v2.1.0)

- fix: use commonJS for NewRelic config [`#578`](https://bitbucket.org/calmisland/kidsloop-user-service/pull-requests/578)
- feat/ add @newrelic/apollo-server-plugin [`#575`](https://bitbucket.org/calmisland/kidsloop-user-service/pull-requests/575)
- feat: add basic New Relic integration [`#569`](https://bitbucket.org/calmisland/kidsloop-user-service/pull-requests/569)
...
- 🤓 Document release process [`b5b62f6`](https://bitbucket.org/calmisland/kidsloop-user-service/commits/b5b62f634a9c2beeb8abb8f17cd0c9c5f6ac681d)
- 🛠 Change tag script to be executable [`3f28062`](https://bitbucket.org/calmisland/kidsloop-user-service/commits/3f280625178208057d45fd7b278c5f8783d60d92)
